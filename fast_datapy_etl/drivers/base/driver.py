...
class BaseDriver:
    ...
    def __init__(self, settings_dict, base_driver:BASE_DRIVER = BASE_DRIVER.ODBC, alias:str = "Default" ):
...
#        self.validation = self.validation_class(self)
 ...
 v       read from the database, it is always returned in this time zone.
        When the database backend supports time zones, it doesn't matter which
        time zone  uses, as long as aware datetimes are used everywhere.
        Other users connecting to the database can choose their own time zone.
        When the database backend doesn't support time zones, the time zone
         uses may be constrained by the requirements of other users of
        the database.
        """
    ...
    def disable_constraint_checking(self):
        ...
        constraint checking. Should return True if tas constraints were
    ...
    def is_usable(self):
        ...
        as that may prevent  from recycling unusable connections.
        """
        raise NotImplementedError(
    ...
    def wrap_database_errors(self):
        ...
        exceptions using 's common wrappers.
        """
